...
open class WinamaxParser(override val cardroom: Cardroom, override val filePath: String) : Parser, CardroomParser() {
    ...
    private val ANTE_BLIND = "*** ANTE/BLINDS ***"
    private val PRE_FLOP = "*** PRE-FLOP ***"
    private val FLOP = "*** FLOP ***"
    private val TURN = "*** TURN ***"
    private val RIVER = "*** RIVER ***"
    private val SHOW_DOWN = "*** SHOW DOWN ***"
    protected val SUMMARY = "*** SUMMARY ***"
    private val NEW_HAND = "Winamax Poker"
    ...
    private val TOTAL_POT = "Total pot "
    private val DEALT_TO = "Dealt to "
    private val DEALT = "Dealt"
    private val DENIES = "denies"
    private val POSTS = "posts"
    private val SMALL = "small"
    private val BUY_IN = "buyIn: "
    private val LEVEL = "level:"
    private val LEVEL_SPACE = LEVEL + SPACE
    private val PLUS_SPACE = PLUS + SPACE
    private val IS_THE_BUTTON = "is the button"
    private val HANDID_HASHTAG = "HandId: #"
    private val MINUS_HANDID = " - HandId:"
    private val MAX = "max"
